...
import com.paradroid.util.AchievementHandler.AchievementObj;
...
public enum GridAchievements {
    ...
    private Pane prepareAchievement(ArrayList<AchievementObj> listOfAchievements, int counter) {
        ...
        if (listOfAchievements.get(counter).total - listOfAchievements.get(counter).score <= 0) {
            achievementIcon = new ImageView(new Image(new File("Game//src//com//paradroid//resources//menuSelection/unlockedTrophy.png").toURI().toString()));
        } else {
            achievementIcon = new ImageView(new Image(new File("Game//src//com//paradroid//resources//menuSelection/lockedTrophy.png").toURI().toString()));
        }
