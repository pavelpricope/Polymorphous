...
import com.paradroid.Network.packets.PacketCreateLobby;
import com.paradroid.Network.packets.PacketLobbyInfo;
...
public enum MenuPages {
    ...
    MAIN_MENU(new Node[]{
            new ImageView(new Image(new File("Game//src//com//paradroid//resources//logo.png").toURI().toString())),
        ...
        Platform.exit();
        Reader.backupAchievements("Game/src/com/paradroid/util/AchievementHandler/achievements.txt");
        System.exit(0);
    }}, true),
    ...
    INSTRUCTIONS_MENU(new Node[]{
            new ImageView(new Image(new File("Game//src//com//paradroid//util//menuHandler//Instructions.png").toURI().toString())),
            UIobjectsAssets.buttonBack.getButton(),
