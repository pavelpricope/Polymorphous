...
import com.paradroid.Network.packets.PacketDisconnect;
import com.paradroid.Network.packets.PacketLogin;
import com.paradroid.Network.packets.PacketMapReq;
import com.paradroid.ai.agents.Bot;
...
import com.paradroid.main.Objects.GameInfo;
import com.paradroid.main.Objects.GameObject;
import com.paradroid.main.Objects.ID;
import com.paradroid.main.Objects.Map;
import com.paradroid.main.Player.Player;
import com.paradroid.util.AchievementHandler.Reader;
import com.paradroid.util.audioHandler.AudioManager;
import com.paradroid.util.mapGen.GenMap;
import com.paradroid.util.menuHandler.FlipCanvas;
import com.paradroid.util.menuHandler.GridAchievements;
import com.paradroid.util.menuHandler.MenuPages;
import com.paradroid.util.menuHandler.TableLobby;
...
public class Game extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Reader.restoreAchievements("Game/src/com/paradroid/util/AchievementHandler/achievements.txt");
    ...
    private void createMenu() {
        vBox = new VBox();
        vBox.getStylesheets().add("com/paradroid/resources/application.css");
